...
VNFSFK code has been formally scanned during build time using NexusIQ and all Critical vulnerabilities found in these scans are closed. The 'VNFSFK security vulnerabilities and their workarounds <https://bestpractices.coreinfrastructure.org/en/projects/1588>'_ have been documented as part of the project.

***Quick Links***
 	- `VNFSFK project page <https://wiki.onap.org/display/DW/VNF+SDK+Project>'_
 	
 	- `Badging information for VNFSFK <https://bestpractices.coreinfrastructure.org/en/projects/1588>'_
 	
 	- `Project Vulnerability Review Table for VNFSFK <https://wiki.onap.org/pages/viewpage.action?pageId=28377592>'_
